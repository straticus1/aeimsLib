...
exports.NativeBLEModule = void 0;
const events_1 = require("events");
/**
 * Native BLE Module
 * Provides optimized BLE functionality for React Native apps
 */
class NativeBLEModule extends events_1.EventEmitter {
     ...
     */
    async writeCharacteristic(deviceId, serviceId, characteristicId, value, withResponse = true) {
        const device = this.devices.get(deviceId);
        if (!device || !device.connected) {
            throw new Error('Device not connected');
        }
     ...
     */
    async enableNotifications(deviceId, serviceId, characteristicId) {
        const device = this.devices.get(deviceId);
        if (!device || !device.connected) {
            throw new Error('Device not connected');
        }
     ...
     */
    async disableNotifications(deviceId, serviceId, characteristicId) {
        const device = this.devices.get(deviceId);
        if (!device || !device.connected) {
            throw new Error('Device not connected');
        }
...
exports.NativeBLEModule = NativeBLEModule;
//# sourceMappingURL=NativeBLEModule.js.map